 ...
 */
export function toCollection(graphQLObject: GraphQLObjectInstanceType, injectFiltersFromParent?: Function, parentGraphQLObject?: ?any) {
  ...
  if (!collections[name]) {
    collections[name] = {
      ...
      resolve: (parent: ?any, filters: any) => {
 ...
 */
export function toRecord(graphQLObject: GraphQLObjectInstanceType, injectFiltersFromParent?: Function) {
  return {
    type: graphQLObject,
